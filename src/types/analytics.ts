...
export type MunicipioAnalyticsRecord = {
  ...
  loc_pct_movil?: number;
  pob_pct_movil?: number;
  loc_pct_5g_garantizada?: number;
  pob_pct_5g_garantizada?: number;
  localidades_n?: number;
  brecha_4g_pp?: number;
  cluster_id?: number | null;
  cluster_label?: string;
  irs_indice?: number;
  irs_grado_texto?: string;
  irs_pct_viv_sin_agua?: number;
  irs_pct_viv_sin_drenaje?: number;
  irs_pct_viv_sin_luz?: number;
  irs_pct_sin_derechohabiencia?: number;
  ookla_int_avg_speed?: number;
  ookla_pct_4g?: number;
  ookla_pct_5g?: number;
  ookla_cubierto?: boolean;
